<?php
namespace Marmot\Basecode\Adapter\Restful\Repository;

use Marmot\Basecode\Adapter\Restful\Adapter\CacheResponse\ICacheResponseAdapter;
use Marmot\Basecode\Adapter\Restful\Adapter\CacheResponse\CacheResponseCacheAdapter;
use Marmot\Basecode\Adapter\Restful\Adapter\CacheResponse\MockCacheResponseCacheAdapter;
...
class CacheResponseRepositoryTest extends TestCase
{
    ...
    public function testDefaultGetAdapter()
    {
        $this->assertInstanceOf(
            'Marmot\Basecode\Adapter\Restful\Adapter\CacheResponse\CacheResponseCacheAdapter',
