...
class CacheResponseCacheAdapterTest extends TestCase
{
    ...
    public function testImplementICacheResponseAdapter()
    {
        $this->assertInstanceOf(
            'Marmot\Basecode\Adapter\Restful\Adapter\CacheResponse\ICacheResponseAdapter',
            $this->stub
        );
    }
    ...
    {
        $this->assertInstanceOf(
            'Marmot\Basecode\Adapter\Restful\Translator\CacheResponseTranslator',
    ...
    {
        $this->assertInstanceOf(
            'Marmot\Basecode\Adapter\Restful\Adapter\CacheResponse\Query\CacheResponseDataCacheQuery',
